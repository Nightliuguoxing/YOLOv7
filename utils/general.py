...
def check_git_status():
    ...
    try:
        ...
        assert not isdocker(), 'skipping check (Docker images)'
...
def check_imshow():
    ...
    try:
        ...
        print(f'WARNING: Environment does not support cv2.imshow() or PIL Image.show() images displays\n{e}')
        return False
...
def segment2box(segment, width=640, height=640):
    # Convert 1 segment anns to 1 box anns, applying inside-images constraint, i.e. (xy1, xy2, ...) to (xyxy)
...
def bbox_iou_bak(box1, box2, x1y1x2y2=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):
    # Returns the IoU of box1 to box2. box1 is 4, box2 is nx4
    box2 = box2.T
